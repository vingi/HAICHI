...
namespace MVCBase.Common
{
    public class HtmlPagerControl
    {
        ...
        public string Render()
        {
            ...
            builder.Append("<div style=\"text-align: center;margin: 10px;\">");
            if (this._page_count > 1)
            {
                //builder.Append("<div style=\"text-align: center;margin: 10px;font-family: 黑体;\"><div style=\"float: left;\">總 <span style=\"color: red;\">" + this._totalcount.ToString() + "</span> 筆</div><div style=\"float: right;\">共 <span id=\"" + this._totalpageid + "\" style=\"color: red;\">" + this._page_count.ToString() + "</span> 頁</div>");
