...
namespace MVCBase.Common
{
    public class HtmlPageInfo : ICloneable
    {
        ...
        public string Render()
        {
            ...
            StringBuilder builder = new StringBuilder();
            if (!this._text.Equals("首頁") && !this._text.Equals("末頁"))
            {
                builder.Append("<span " + this._clickevent + " ");
                if (this._text.Equals("下一頁"))
                    builder.Append(" class=\"page_r\" ");
                else if (this._text.Equals("上一頁"))
                    builder.Append(" class=\"page_l\" ");
                else
                    builder.Append(" class=\"page_p\" id=\"page" + this._index_page.ToString() + "\" ");
